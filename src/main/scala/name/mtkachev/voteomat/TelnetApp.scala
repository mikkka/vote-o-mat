...
object TelnetApp {
  def main(args: Array[String]): Unit = {
    ...
    connections.runForeach { connection =>
      ...
      val g: Flow[String, String, NotUsed] = Flow.fromGraph(createLogicGrapth(stateCtx, sessionCtx, welcome))
  ...
  private def createLogicGrapth(stateCtx: VoteStateCtx, sessionCtx: SessionCtx, welcome: Source[String, NotUsed]) = {
